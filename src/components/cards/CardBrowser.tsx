 ...
 * catalogue, factored out of the standalone /cards page so it can be
 * embedded elsewhere (currently: below the deck list on /decks and on the
 * empty-state landing page) without duplicating the fetch/state logic.
 */
export function CardBrowser({ heading = "Search cards" }: { heading?: string }) {
